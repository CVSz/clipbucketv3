-- $Id: cb_new_install.sql 750 2011-12-02 05:04:13Z atlantean11 $
-- phpMyAdmin SQL Dump
-- version 3.2.0.1
...
(467, 'en', 'vdo_embed_opt2', 'No, People can not play this video on other websites'),
...
(709, 'en', 'user_dallow_rating_msg1', 'users can not rate'),
...
(745, 'en', 'vdo_cat_err2', 'You can not select more than %d categories'),
...
(752, 'va', 'value', 'value'),
(753, 'en', 'vdo_cat_err3', 'Please select at least 1 category'),
...
(772, 'en', 'cat_default_err', 'Default can not be deleted, please choose other category as &#8220;default&#8221; and then delete this'),
...
(798, 'en', 'insufficient_privileges_loggin', 'You can not access this page Click Here to <a href="%s">Login</a> or <a href="%s">Register</a>'),
